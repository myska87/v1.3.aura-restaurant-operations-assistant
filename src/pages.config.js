...
const pages = [
  ...
  },
  {
    name: 'MyChecklists',
    path: '/my-checklists',
    file: 'MyChecklists.jsx',
    component: MyChecklists,
    public: false
  },
  {
    name: 'ExecuteChecklist',
    path: '/execute-checklist',
    file: 'ExecuteChecklist.jsx',
    component: ExecuteChecklist,
    public: false
  },
  {
    name: 'ChecklistMonitor',
    path: '/checklist-monitor',
    file: 'ChecklistMonitor.jsx',
    component: ChecklistMonitor,
    public: false
  },
  {
    name: 'MenuManagement',
    path: '/menu-management',
    file: 'MenuManagement.jsx',
  ...
  },
  {
    ...
    path: '/weekly-rota',
    file: 'WeeklyRota.jsx',
    component: WeeklyRota,
    public: false
  },
  {
    name: 'WeeklyRotaSchedule',
    path: '/weekly-rota-schedule',
    file: 'WeeklyRotaSchedule.jsx',
    component: WeeklyRotaSchedule,
    public: false
  },
  {
    name: 'InventoryManagement',
    path: '/inventory-management',
    file: 'InventoryManagement.jsx',
  ...
  },
  {
    ...
    path: '/staff-model',
    file: 'StaffModel.jsx',
    component: StaffModel,
    public: false
  },
  {
    name: 'CultureBuilding',
    path: '/culture-building',
    file: 'CultureBuilding.jsx',
    component: CultureBuilding,
    public: false
  },
  {
    name: 'OnboardingTraining',
    path: '/onboarding-training',
    file: 'OnboardingTraining.jsx',
    component: OnboardingTraining,
    public: false
  },
  {
    name: 'PerformanceGrowth',
    path: '/performance-growth',
    file: 'PerformanceGrowth.jsx',
  ...
  },
  {
    ...
    file: 'CoachingDashboard.jsx',
    component: CoachingDashboard,
    public: false
  },
  {
    name: 'StartCoachingSession',
    path: '/start-coaching-session',
    file: 'StartCoachingSession.jsx',
    component: StartCoachingSession,
    public: false
  },
  {
    name: 'CommunicationFeedback',
    path: '/communication-feedback',
    file: 'CommunicationFeedback.jsx',
    component: CommunicationFeedback,
    public: false
  },
  {
    name: 'TeamChat',
  ...
  },
  {
    name: 'TeamDirectory',
    path: '/team-directory',
    file: 'TeamDirectory.jsx',
    component: TeamDirectory,
    public: false
  },
  {
    name: 'AdvancedChecklists',
    path: '/advanced-checklists',
    file: 'AdvancedChecklists.jsx',
    component: AdvancedChecklists,
    public: false
  },
  {
    name: 'RestaurantRoutines',
    path: '/restaurant-routines',
    file: 'RestaurantRoutines.jsx',
    component: RestaurantRoutines,
    public: false
  },
  {
    name: 'FormBuilder',
  ...
  },
  {
    ...
    file: 'AttendanceReports.jsx',
    component: AttendanceReports,
    public: false
  },
  {
    name: 'DailyChecklists',
    path: '/daily-checklists',
    file: 'DailyChecklists.jsx',
    component: DailyChecklists,
    public: false
  },
  {
    name: 'ActiveChecklist',
    path: '/active-checklist',
    file: 'ActiveChecklist.jsx',
  ...
  },
  {
    ...
    file: 'ChecklistReview.jsx',
    component: ChecklistReview,
    public: false
  },
  {
    name: 'WeeklyPayrollReport',
    path: '/weekly-payroll-report',
    file: 'WeeklyPayrollReport.jsx',
    component: WeeklyPayrollReport,
    public: false
  },
  {
    name: 'StaffWagesReport',
    path: '/staff-wages-report',
    file: 'StaffWagesReport.jsx',
    component: StaffWagesReport,
    public: false
  },
  {
