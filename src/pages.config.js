...
import SOPsDashboard from './pages/SOPsDashboard';
import QualityDashboardHub from './pages/QualityDashboardHub';
...
export const PAGES = {
    ...
    "SOPsDashboard": SOPsDashboard,
    "QualityDashboardHub": QualityDashboardHub,
