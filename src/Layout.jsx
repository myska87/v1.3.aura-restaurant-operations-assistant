...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full bg-gradient-to-b from-[#014D40] to-[#016854] border-r border-slate-700 z-50 transition-transform duration-300 ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-slate-700">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-xs text-center text-slate-300 font-medium mt-3">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-6">
                      ...
                      <Link
                        ...
                        className={`flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all ${
                          active
                            ...
                            : "text-slate-200 hover:bg-[#025a4a]"
                        }`}
                      >
            ...
            {isManager && (
              <div>
                <div className="px-3 mb-2 mt-6 pt-6 border-t border-slate-700">
