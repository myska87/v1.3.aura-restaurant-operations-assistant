...
const DEFAULT_PERMISSIONS = {
  owner: 'all',
  admin: 'all',
  manager: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'staff.view', 'staff.directory', 'staff.rota', 'staff.payroll', 'staff.analytics', 'operations.hub', 'forms.complete', 'forms.create', 'checklists.execute', 'checklists.manage', 'inventory.view', 'inventory.edit', 'inventory.order', 'suppliers.manage', 'quality.view', 'quality.checks', 'hygiene.access', 'sops.view', 'sops.create', 'documents.view', 'documents.create', 'documents.sign', 'reports.view', 'analytics.access', 'settings.access', 'settings.users'],
  chef: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'forms.complete', 'checklists.execute', 'inventory.view', 'inventory.edit', 'quality.view', 'quality.checks', 'hygiene.access', 'sops.view', 'documents.view', 'documents.sign'],
  sous_chef: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'forms.complete', 'checklists.execute', 'inventory.view', 'quality.checks', 'hygiene.access', 'sops.view', 'documents.view', 'documents.sign'],
  line_cook: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'forms.complete', 'checklists.execute', 'quality.checks', 'sops.view', 'documents.view', 'documents.sign'],
  server: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'forms.complete', 'checklists.execute', 'sops.view', 'documents.view', 'documents.sign'],
  bartender: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'forms.complete', 'checklists.execute', 'sops.view', 'documents.view', 'documents.sign'],
  host: ['dashboard.view', 'my_shifts.view', 'my_tasks.view', 'clock_in_out.access', 'team_chat.access', 'forms.complete', 'checklists.execute', 'sops.view', 'documents.view', 'documents.sign'],
...
export default function RolePermissionsCenter() {
  ...
  const updatePermissionMutation = useMutation({
    mutationFn: async ({ permissionId, isEnabled }) => {
      await base44.entities.RolePermission.update(permissionId, {
        is_enabled: isEnabled,
        updated_by: user.email,
        updated_by_name: user.full_name,
      });
  ...
  const saveChanges = async () => {
    for (const [permissionId, isEnabled] of Object.entries(changes)) {
      await updatePermissionMutation.mutateAsync({ permissionId, isEnabled });
    }
    setChanges({});
