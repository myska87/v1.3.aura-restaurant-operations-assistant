...
// Helper function to get default department
const getDefaultDepartment = (position) => {
  const deptMap = {
    'chef': 'kitchen',
    'line cook': 'kitchen',
    'line_cook': 'kitchen', // Added from outline
    ...
    'front_of_house': 'front_of_house', // Added from outline
    'maintenance': 'maintenance', // Added from outline
  };
