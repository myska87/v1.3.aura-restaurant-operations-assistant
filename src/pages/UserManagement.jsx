      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
        <Card className="max-w-md">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Only admins and managers can access this page.</p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">
                    {unifiedUsers.filter(u => u.status === 'active').length}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-600">
                    {unifiedUsers.filter(u => u.position === 'manager' || u.position === 'owner').length}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-indigo-600">
                    {unifiedUsers.filter(u => u.has_team_member).length}
                  </p>
                </div>
          ...
          <CardContent className="p-4">
            <div className="flex gap-4">
              ...
              <select
                ...
                className="w-32 px-3 py-2 border border-gray-300 rounded-md bg-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
